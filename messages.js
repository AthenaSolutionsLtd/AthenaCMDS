export default {
  ...
  CURRENT_LANGUAGE: {
    english: "The current language is set to english.",
    spanish: "El idioma actual está establecido en español.",
    portuguese: "O idioma atual está definido como português.",
    russian: "Текущий язык установлен на русский.",
    german: "Die Sprache ist aktuell auf Deutsch gesetzt.",
    dutch: "De huidige taal is ingesteld op Nederlands.",
    french: "La langue actuelle est réglée sur français.",
  },
  NEW_LANGUAGE: {
    english: "Language set to english.",
    spanish: "Idioma configurado en español.",
    portuguese: "Idioma configurado para português.",
    russian: "Язык установлен на русский.",
    german: "Die Sprache Deutsch wurde ausgewählt.",
    dutch: "Taal ingesteld op Nederlands.",
    french: "Langue réglée sur français.",
  },
  BOT_OWNERS_ONLY: {
  ...
  MISSING_PERMISSION: {
    ...
    portuguese:
      "Você precisa ter a permissão {PERM} para utilizar este comando.",
    russian: "У вас должно быть право {PERM}, чтобы использовать эту команду. ",
    german:
      "Du benötigst die Berechtigung {PERM}, um diesen Befehl nutzen zu können.",
    dutch:
      "Je moet de permissie {PERM} hebben om dit commando te kunnen gebruiken.",
    french:
      "Vous devez avoir la permission {PERM} pour utiliser cette commande.",
  },
  MISSING_ROLES: {
    english:
      "You do not have the required roles to use this command! You need one of the following: {ROLES}",
    spanish:
      "¡No tienes los roles necesarios para usar este comando! Necesita uno de los siguientes: {ROLES}",
    portuguese:
      "Você não tem o cargo necessário para usar este comando! Você precisa de um dos seguintes: {ROLES}",
    russian:
      "У вас нет необходимых ролей для использования этой команды! Вам понадобится одно из следующего: {ROLES}",
    german:
      "Sie haben nicht die erforderlichen Rollen, um diesen Befehl zu verwenden! Sie benötigen eine der folgenden Möglichkeiten: {ROLES}",
    dutch:
      "Je hebt de vereiste rollen om dit commando te gebruiken niet! Je hebt een van de volgende nodig: {ROLES}",
    french:
      "Vous n'avez pas les rôles requis pour utiliser cette commande! Vous avez besoin de l'un des éléments suivants: {ROLES}",
  },
  COOLDOWN: {
    ...
    portuguese:
      "Você precisa esperar {COOLDOWN} antes de usar este comando novamente.",
    russian:
      "Вы должны подождать {COOLDOWN} перед использованием данной команды снова.",
    german:
      "Du musst {COOLDOWN} warten, bevor du diesen Befehl erneut nutzen kannst.",
    dutch: "U moet {COOLDOWN} wachten voordat u dat commando weer gebruikt.",
    french:
      "Vous devez attendre {COOLDOWN} avant d'utiliser cette commande à nouveau.",
  },
  ...
  CANNOT_ENABLE_DISABLE_IN_DMS: {
    ...
    portuguese:
      "Você não pode ativar ou desativar comandos em mensagens privadas.",
    russian: "Вы не можете включать или отключать команды в личных сообщениях.",
    german:
      "Du kannst keine Befehle in Privatnachrichten aktivieren oder deaktivieren.",
    dutch: "U kunt geen commando's in- of uitschakelen in privéberichten.",
    french:
      "Vous ne pouvez pas activer ou désactiver les commandes dans les messages privés.",
  },
  ...
  CANNOT_CHANGE_REQUIRED_ROLES_IN_DMS: {
    ...
    portuguese:
      "Você não pode alterar as funções necessárias em mensagens privadas",
    russian: "Вы не можете изменить требуемые роли в личных сообщениях.",
    german:
      "Du kannst die benötigen Rolen nicht in Privatnachrichten festlegen.",
    dutch: "U kunt vereiste rollen niet wijzigen in privéberichten.",
    french:
      "Vous ne pouvez pas modifier les rôles requis dans les messages privés.",
  },
  REMOVED_ALL_REQUIRED_ROLES: {
    ...
    portuguese:
      "Removidas todas as permissões necessárias para o comando {COMMAND}.",
  ...
  SYNTAX_ERROR: {
    ...
    russian:
      'Неправильное использование, пожалуйста используйте "{PREFIX}{COMMAND} {ARGUMENTS}"',
    ...
    french:
      'Utilisation incorrecte! Veuillez utiliser "{PREFIX}{COMMAND} {ARGUMENTS}".',
  },
  NO_DATABASE_FOUND: {
  ...
  NO_REACT_PERMS: {
    english:
      'This bot needs the "Add Reactions" permission to use the help menu.',
    spanish:
      'Este bot necesita el permiso "Añadir reacciones" para usar el menú de ayuda.',
    portuguese:
      'Este bot precisa da permissão "Adicionar reações" para usar o menu de ajuda.',
    russian:
      'Этому боту требуется право "Добавлять реакции", что-бы использовать меню помощи.',
    german:
      'Der Bot benötigt die Berechtigung "Reaktionen hinzufügen", damit das Hilfemenü genutzt werden kann.',
    dutch:
      'Deze bot heeft de toestemming "Reacties toevoegen" nodig om het helpmenu te gebruiken.',
    french:
      "Ce robot a besoin de l'autorisation \"d'ajouter des commentaires\" pour utiliser le menu d'aide.",
  },
  EXCEPTION: {
    english:
      "An error occurred when running this command! This error has been reported to the developers.",
    spanish:
      "¡Se produjo un error al ejecutar este comando! Se ha informado de este error a los desarrolladores.",
    portuguese:
      "Ocorreu um erro ao executar este comando! Este erro foi relatado aos desenvolvedores.",
    russian:
      "Произошла ошибка при выполнении этой команды! Об этой ошибке было сообщено разработчикам.",
    german:
      "Beim Ausführen dieses Befehls ist ein Fehler aufgetreten! Dieser Fehler wurde den Entwicklern gemeldet.",
    dutch:
      "Er is een fout opgetreden bij het uitvoeren van dit commando! Deze fout is gemeld aan de ontwikkelaars.",
    french:
      "Une erreur s'est produite lors de l'exécution de cette commande! Cette erreur a été signalée aux développeurs.",
  },
  NO_TAGGED_CHANNELS: {
  ...
  ALLOWED_CHANNELS: {
    ...
    russian:
      "Вы можете использовать эту команду только в следующих случаях: {CHANNELS}.",
    ...
    french:
      "Vous ne pouvez utiliser cette commande que dans les cas suivants: {CHANNELS}.",
  },
  ...
  REQUIRE_ROLES: {
    ...
    spanish:
      "Debe especificar qué roles pueden usar este comando con `{PREFIX} requiredroles {COMMAND} <ID de rol>`.",
    portuguese:
      "Você deve especificar quais funções podem usar este comando com `{PREFIX} funções necessárias {COMANDO} <ID da função>`.",
    russian:
      "Вы должны указать, какие роли могут использовать эту команду с `{PREFIX} requiredroles {COMMAND} <role ID>`.",
    german:
      "Sie müssen mit `{PREFIX}requiredroles {COMMAND} <Rollen-ID>` angeben, welche Rollen diesen Befehl verwenden können.",
    dutch:
      "Je moet specificeren welke rollen dit commando kunnen gebruiken met `{PREFIX}requiredroles {COMMAND} <role ID>`.",
    french:
      "Vous devez spécifier quels rôles peuvent utiliser cette commande avec `{PREFIX}requiredroles {COMMAND} <role ID>`.",
  },
  HELP_MENU: {
    TITLE: {
      english: "Help Menu",
    ...
    SELECT_A_CATEGORY: {
      ...
      spanish:
        "Seleccione una categoría de comando haciendo clic en su reacción.",
      ...
      german:
        "Bitte wähle eine Befehlskategorie aus, indem du auf eine Reaktion klickst.",
      dutch: "Selecteer een commando categorie door op de reactie te klikken.",
      french:
        "Sélectionnez une catégorie de commande en cliquant sur la réaction.",
    },
    COMMANDS: {
      english: "commands",
      spanish: "comandos",
    ...
    DESCRIPTION_SECOND_LINE: {
      ...
      german:
        "Benutze ⬅ und ➡, um zwischen den Seiten hin und her zu wechseln.",
