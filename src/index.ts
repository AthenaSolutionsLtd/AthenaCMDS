...
export default class AthenaCMDS extends EventEmitter {
  ...
  private async setUp(client: Client, options?: Options) {
    if (!client) {
      new Logger("debug", "America/Chicago", "logs").log(
        "error",
        "Main",
        "No Discord JS Client provided as first argument!"
      );
    }
    ...
    new Logger("debug", "America/Chicago", "logs").log(
      "success",
      "Main",
      "AthenaClient is now running."
    );
  }

  public setMongoPath(mongoPath: string | undefined): AthenaCMDS {
    new Logger("debug", "America/Chicago", "logs").log(
      "error",
      "Main",
  ...
  public setDisplayName(displayName: string): AthenaCMDS {
  ...
  public setDefaultPrefix(defaultPrefix: string): AthenaCMDS {
  ...
  public setPrefix(guild: Guild | null, prefix: string): AthenaCMDS {
    if (guild) {
  ...
  public setColor(color: ColorResolvable | null): AthenaCMDS {
    this._color = color;
    return this;
  }
  ...
  public setCategorySettings(category: ICategorySetting[]): AthenaCMDS {
    for (let { emoji, name, hidden, customEmoji } of category) {
      ...
      this._categories.set(
        name,
        targetEmoji || this.categories.get(name) || ""
      );
  ...
  public setTagPeople(tagPeople: boolean): AthenaCMDS {
  ...
  public setBotOwner(botOwner: string | string[]): AthenaCMDS {
    new Logger("debug", "America/Chicago", "logs").log(
      "error",
      "Main",
  ...
  public setDefaultLanguage(defaultLanguage: string): AthenaCMDS {
